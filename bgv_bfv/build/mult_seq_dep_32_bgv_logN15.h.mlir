...
#ciphertext_space_L7 = #lwe.ciphertext_space<ring = #ring_rns_L7_1_x1024, encryption_type = lsb>
#ciphertext_space_L7_D3 = #lwe.ciphertext_space<ring = #ring_rns_L7_1_x1024, encryption_type = lsb, size = 3>
...
module attributes {backend.openfhe, scheme.bgv} {
  ...
  func.func @mult_dep__generate_crypto_context() -> !cc {
    %params = openfhe.gen_params  {firstModSize = 60 : i64, insecure = true, mulDepth = 32 : i64, plainMod = 65537 : i64, ringDim = 32768 : i64, scalingModSize = 60 : i64, scalingTechniqueFixedManual = true} : () -> !params
